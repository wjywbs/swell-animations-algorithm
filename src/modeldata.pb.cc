...
const ::google::protobuf::Descriptor* RotationPoints_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  RotationPoints_reflection_ = NULL;
...
void protobuf_AssignDesc_AnimationDataSerializer_2fmodeldata_2eproto() {
  ...
  Node_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(Node));
  RotationPoints_descriptor_ = file->message_type(4);
  static const int RotationPoints_offsets_[3] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RotationPoints, rotation_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RotationPoints, numframes_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RotationPoints, startframe_),
  };
  RotationPoints_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      RotationPoints_descriptor_,
      RotationPoints::default_instance_,
      RotationPoints_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RotationPoints, _has_bits_[0]),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RotationPoints, _unknown_fields_),
      -1,
      ::google::protobuf::DescriptorPool::generated_pool(),
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(RotationPoints));
}
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
    RotationPoints_descriptor_, &RotationPoints::default_instance());
}
...
void protobuf_ShutdownFile_AnimationDataSerializer_2fmodeldata_2eproto() {
  ...
  delete RotationPoints::default_instance_;
  delete RotationPoints_reflection_;
}
...
void protobuf_AddDesc_AnimationDataSerializer_2fmodeldata_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\030\002 \003(\0132\027.swellanimations.Vector\"\325\001\n\tMode"
    ...
    "mations.Vector\022/\n\016rotationpoints\030\004 \003(\0132\027"
    ".swellanimations.Vector\022\026\n\016numberOfFrame"
    "s\030\005 \001(\005\")\n\006Vector\022\t\n\001x\030\001 \002(\002\022\t\n\001y\030\002 \002(\002\022"
    "\t\n\001z\030\003 \002(\002\"\275\001\n\004Node\022\014\n\004name\030\001 \001(\t\022)\n\010pos"
    "ition\030\002 \001(\0132\027.swellanimations.Vector\022,\n\013"
    "eularAngles\030\003 \001(\0132\027.swellanimations.Vect"
    "or\022\'\n\010children\030\004 \003(\0132\025.swellanimations.N"
    "ode\022%\n\006parent\030\005 \001(\0132\025.swellanimations.No"
    "de\"b\n\016RotationPoints\022)\n\010Rotation\030\001 \001(\0132\027"
    ".swellanimations.Vector\022\021\n\tnumFrames\030\002 \002"
    "(\005\022\022\n\nstartFrame\030\003 \002(\005", 702);
  ...
  RotationPoints::default_instance_ = new RotationPoints();
  ...
  RotationPoints::default_instance_->InitAsDefaultInstance();
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      // repeated .swellanimations.Vector rotationpoints = 4;
      case 4: {
        if (tag == 34) {
      ...
      // optional int32 numberOfFrames = 5;
      case 5: {
        if (tag == 40) {
...
#ifndef _MSC_VER
const int RotationPoints::kRotationFieldNumber;
const int RotationPoints::kNumFramesFieldNumber;
const int RotationPoints::kStartFrameFieldNumber;
#endif  // !_MSC_VER

RotationPoints::RotationPoints()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:swellanimations.RotationPoints)
}

void RotationPoints::InitAsDefaultInstance() {
  rotation_ = const_cast< ::swellanimations::Vector*>(&::swellanimations::Vector::default_instance());
}

RotationPoints::RotationPoints(const RotationPoints& from)
  : ::google::protobuf::Message() {
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:swellanimations.RotationPoints)
}

void RotationPoints::SharedCtor() {
  _cached_size_ = 0;
  rotation_ = NULL;
  numframes_ = 0;
  startframe_ = 0;
...
RotationPoints::~RotationPoints() {
  // @@protoc_insertion_point(destructor:swellanimations.RotationPoints)
  SharedDtor();
}

void RotationPoints::SharedDtor() {
  if (this != default_instance_) {
    delete rotation_;
  }
}

void RotationPoints::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ::google::protobuf::Descriptor* RotationPoints::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return RotationPoints_descriptor_;
}

const RotationPoints& RotationPoints::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_AnimationDataSerializer_2fmodeldata_2eproto();
  return *default_instance_;
}

RotationPoints* RotationPoints::default_instance_ = NULL;

RotationPoints* RotationPoints::New() const {
  return new RotationPoints;
}

void RotationPoints::Clear() {
#define OFFSET_OF_FIELD_(f) (reinterpret_cast<char*>(      \
  &reinterpret_cast<RotationPoints*>(16)->f) - \
   reinterpret_cast<char*>(16))
...
bool RotationPoints::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:swellanimations.RotationPoints)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      // optional .swellanimations.Vector Rotation = 1;
      case 1: {
        if (tag == 10) {
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
...
success:
  // @@protoc_insertion_point(parse_success:swellanimations.RotationPoints)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:swellanimations.RotationPoints)
  return false;
#undef DO_
}

void RotationPoints::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:swellanimations.RotationPoints)
  // optional .swellanimations.Vector Rotation = 1;
  if (has_rotation()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
  ...
  // @@protoc_insertion_point(serialize_end:swellanimations.RotationPoints)
}

::google::protobuf::uint8* RotationPoints::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:swellanimations.RotationPoints)
  // optional .swellanimations.Vector Rotation = 1;
  if (has_rotation()) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteMessageNoVirtualToArray(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:swellanimations.RotationPoints)
  return target;
}

int RotationPoints::ByteSize() const {
  int total_size = 0;
...
void RotationPoints::MergeFrom(const ::google::protobuf::Message& from) {
  GOOGLE_CHECK_NE(&from, this);
  const RotationPoints* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const RotationPoints*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
...
void RotationPoints::MergeFrom(const RotationPoints& from) {
  GOOGLE_CHECK_NE(&from, this);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
...
void RotationPoints::CopyFrom(const ::google::protobuf::Message& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void RotationPoints::CopyFrom(const RotationPoints& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool RotationPoints::IsInitialized() const {
...
void RotationPoints::Swap(RotationPoints* other) {
  if (other != this) {
...
::google::protobuf::Metadata RotationPoints::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = RotationPoints_descriptor_;
  metadata.reflection = RotationPoints_reflection_;
  return metadata;
}
